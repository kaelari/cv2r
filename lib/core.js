...
const core = [
	...
	},
	{
		...
		actors: [
			...
			enemy.fred(0x24, 0x1A, 0x05, 0x5198),
	...
	},
	{
		...
		actors: [
			...
			npc.block(0x09, 0x36, 0x65, 0x0),
			npc.arrow(0x0A, 0x37, 0x0, 0x0),
			npc.arrow(0x0D, 0x37, 0x0, 0x0),
			npc.arrow(0x13, 0x37, 0x0, 0x0),
			
			enemy.skeleton(0x14, 0x0C, 0x1E, 0x5A91),
			enemy.spider(0x14, 0x2B, 0x1E, 0x5A95, { ground: 0x2E }),
			npc.block(0x15, 0x36, 0x66, 0x0),
	...
	},
	{
		...
		actors: [
			...
			npc.blocksideways(0x24, 0x25, 0x85, 0x00),
	...
	},
	{
		...
		actors: [
			...
			npc.block(0x29, 0x0D, 0x45, 0x0),
			enemy.skeleton(0x2C, 0x04, 0x02, 0x6769),
			
			npc.block(0x37, 0x0D, 0x46, 0x0),
	...
	},
	{
		...
		actors: [
			...
			npc.blocksingle(0x24, 0x0C, 0x20, 0x0),
			npc.blocksingle(0x27, 0x0C, 0x20, 0x0),
			npc.blocksingle(0x2A, 0x0C, 0x20, 0x0),
			npc.blocksingle(0x2D, 0x0C, 0x20, 0x0),
	...
	},
	{
		...
		actors: [
            ...
            npc.blocksingle(0x14, 0x0D, 0x20, 0x0),
            npc.blocksingle(0x18, 0x0D, 0x20, 0x0),
            npc.blocksingle(0x1C, 0x0D, 0x20, 0x0),
	...
	},
	{
		...
		actors: [
			// no dracula???  is spawned by the function that does the little animation of simon walking up
			// and throwing drac's pieces into the fire.
		]
	}
];
