...
const BLOCK = 0x22;
const BLOCKSIDEWAYS = 0x21;
const BLOCKSINGLE = 0x34;
const ARROW = 0x20;
...
const npcs = [
    ...
    {name: 'block', id: BLOCK},
    {name: 'blocksideways', id: BLOCKSIDEWAYS},
    {name: 'blocksingle', id: BLOCKSINGLE},
...
const enemies = exports.enemies = [
	{ name: 'bat', id: BAT, pos: POS_AIR, sprite: 0x01 },
	{ name: 'blob', id: BLOB, pos: POS_GROUND, sprite: 0x05 },
	{ name: 'bone dragon', id: BONE_DRAGON, pos: POS_GROUND, sprite: 0x05, projectile: true, immobile: true },
	{ name: 'bone thrower', id: BONE_THROWER, pos: POS_GROUND, sprite: 0x0A, projectile: true },
	{ name: 'Camilla', id: CAMILLA, pos: POS_AIR, sprite: 0x0A, boss: true, holdsItem: true, projectile: true },
	{ name: 'dead hand', id: DEAD_HAND, pos: POS_DEADHAND, sprite: 0x05, immobile: true },
	{ name: 'Death', id: DEATH, pos: POS_AIR, sprite: 0x09, boss: true, holdsItem: true, projectile: true },
	{ name: 'Dracula', id: DRACULA, pos: POS_AIR, sprite: 0x0C, boss: true, projectile: true },
	{ name: 'eagle', id: EAGLE, pos: POS_AIR, sprite: 0x07 },
	{ name: 'eyeball', id: EYEBALL, pos: POS_AIR, sprite: 0x03 },
	{ name: 'fire ghoul', id: FIRE_GHOUL, pos: POS_GROUND, sprite: 0x05, projectile: true },
	{ name: 'fishman', id: FISHMAN, pos: POS_BELOW, sprite: 0x03, projectile: true },
	{ name: 'floating skull', id: FLOATING_SKULL, pos: POS_AIR, sprite: 0x05 },
	{ name: 'flower', id: FLOWER, pos: POS_GROUND, sprite: 0x07, projectile: true, immobile: true },
	{ name: 'gargoyle', id: GARGOYLE, pos: POS_GROUND, sprite: 0x0A, projectile: true },
	{ name: 'ghost', id: GHOST, pos: POS_AIR, sprite: 0x07 },
	{ name: 'grabber', id: GRABBER, pos: POS_GROUND, sprite: 0x05 },
	{ name: 'harpy', id: HARPY, pos: POS_AIR, sprite: 0x07, projectile: true },
	{ name: 'high jump leech', id: HIGH_JUMP_LEECH, pos: POS_BELOW, sprite: 0x05 },
	{ name: 'leech', id: LEECH, pos: POS_BELOW, sprite: 0x03 },
	{ name: 'lizardman', id: LIZARDMAN, pos: POS_GROUND, sprite: 0x03, projectile: true },
	{ name: 'mansion bat', id: MANSION_BAT, pos: POS_AIR, sprite: 0x0A },
	{ name: 'mansion blob', id: MANSION_BLOB, pos: POS_GROUND, sprite: 0x0A },
	{ name: 'medusa', id: MEDUSA, pos: POS_AIR, sprite: 0x07 },
	{ name: 'mudman', id: MUDMAN, pos: POS_GROUND, sprite: 0x03, projectile: true, immobile: true },
	{ name: 'mummy', id: MUMMY, pos: POS_GROUND, sprite: 0x07 },
	{ name: 'rock', id: ROCK, pos: POS_AIR, sprite: 0x0A },
	{ name: 'skeleton', id: SKELETON, pos: POS_GROUND, sprite: [ 0x03, 0x05, 0x0A ] },
	{ name: 'spear knight', id: SPEAR_KNIGHT, pos: POS_GROUND, sprite: 0x0A },
	{ name: 'spider', id: SPIDER, pos: POS_AIR, sprite: [ 0x03, 0x0A ], projectile: true },
	{ name: 'swamp ghoul', id: SWAMP_GHOUL, pos: POS_GROUND, sprite: 0x05, projectile: true, immobile: true },
	...
	{ name: 'fred', id: ZOMBIE, pos: POS_GROUND, sprite: 0x01 }
	
];

enemies.forEach(({ name, id, pos, boss, projectile, immobile, holdsItem = false }) => {
	const key = camelcase(name);
	enemy[id] = enemy[key] = function(x, y, data, pointer, opts = {}) {
		return Object.assign({ name, id, pos, boss, projectile, immobile, holdsItem, x, y, data, pointer, enemy: true }, opts);
	};
